...
def test_generated_review_prompt_does_not_count_as_review_result():
    result = infer_stage(
        issue=_issue(),
        issue_comments=[],
        linked_pull_request=_pull_request(),
        pr_comments=[
            _comment(
                4,
                "@claude Please review this Pull Request and report REVIEW PASSED or "
                "REVIEW FAILED with findings.",
                "hieuhd10",
                4,
            )
        ],
...
def test_generated_test_prompt_does_not_count_as_test_result():
    result = infer_stage(
        issue=_issue(),
        issue_comments=[],
        linked_pull_request=_pull_request(),
        pr_comments=[
            ...
            _comment(
                6,
                "@claude Please run the tests for this Pull Request and report TEST PASSED "
                "or TEST FAILED.",
                "hieuhd10",
                6,
            ),
    ...
    assert "Run tests" in result.next_recommended_action
